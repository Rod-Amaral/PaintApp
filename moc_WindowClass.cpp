...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MahWindow_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MahWindow_t qt_meta_stringdata_MahWindow = {
    {
QT_MOC_LITERAL(0, 0, 9) // "MahWindow"
...
static const uint qt_meta_data_MahWindow[] = {
...
void MahWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject MahWindow::staticMetaObject = {
    { &childWindow::staticMetaObject, qt_meta_stringdata_MahWindow.data,
      qt_meta_data_MahWindow,  qt_static_metacall, nullptr, nullptr}
};


const QMetaObject *MahWindow::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *MahWindow::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_MahWindow.stringdata0))
        return static_cast<void*>(this);
    return childWindow::qt_metacast(_clname);
}

int MahWindow::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = childWindow::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
